...
def insert_data
  ...
  dataset.insert(name: 'John', email: 'john.example@example.example',
                 encrypted_password: BCrypt::Password.create('admin'), admin: 1)

  dataset.insert(name: 'David', email: 'david.ek@example.example',
                 encrypted_password: BCrypt::Password.create('admin'), admin: 0)

  dataset.insert(name: 'Gustav', email: 'gustav@example.example',
                 encrypted_password: BCrypt::Password.create('admin'), admin: 0)

  dataset.insert(name: 'Admin', email: 'admin@admin',
                 encrypted_password: BCrypt::Password.create('admin'), admin: 1)

  dataset = DB[:policy]

  dataset.insert(title: 'Privacy Policy', body: '<p>We value your data and
    therefore we do our utmost to store it securely.<br>

    We only store the essential personal data required for our service to
    function as intended.

    That means we store the email address associated with your account so
     that we can come in to contact with you if required and so that you
      can access your account.

    We store your name as each post is associated with an account. Your
    password is stored securely in our database using a hashing algorithm.</p>

    <p>Other data received by us is stored with user integrity and privacy
     in mind.</p>

    <p>If there are additional questions as too how we store your data do not
       hesitate to contact us.</p>', id: 1)

  dataset.insert(title: 'Cookie Policy', body: '

    <p>To give you as the visitor the best possible experience on our website,
     we utilize cookies. Cookies are used so that we can
    save your interactions and choices made on the website.

    <br>In some instances third-parties might place cookies on your device to
     track statistics of user interactions.</p>

    <p>You can change the settings on your device to avoid us and third-parties
     from placing cookies on your device. Such settings would
    cause some functions on our website do not work.<p>

    <h1 class="title is-4">What are cookies?</h4>

    <p>A cookie is a small amount of data with a uniquely identifiable label.
    The data is sent from our servers to your device where the
    browser saves it to its memory so that the website can recognize your
     device.</p>

    <p>All websites can place cookies on your device if your browser settings
    allow for it. For this information not to be abused, websites
    can only read data from cookies that they placed on your device.</p>

    <p>There are two types of cookies, permanent and temporary. Permanent
    ookies are stored in a file on your device during a longer time
     frame. Temporary cookies are temporarily placed on your device when
     visiting a website but disappear after closing down the page,
      meaning they are not permanently stored on your device. Most companies
      use cookies on their webpages to improve user experience.
       And the use of cookies can not damage your files or increase the risks
        of malware on your device</p>

    <p>As a user you can change the settings to allow the use of cookies
     automatically in your browser or if you want to be asked before
    they are stored or if you do not agree to any cookies being placed on
       your device.</p>

    <p>Our cookies are used to improve the user experience, with interactive
     messages, the ability to login and use the webpages
    intended functions.<br>If you choose to deactivate cookies we can not
     provide
    our services to you, as cookies are required for our
    site to function properly.</p>

    <br>

    <p>More information about cookies are available at
    <a href="https://www.allaboutcookies.org/cookies/">
    www.allaboutcookies.org</a></p>

    <br>

    <p>All browsers are different. To find information on how to change the
     settings
    for cookies look for information in the help
    function of your browser. You can also manually erase all cookies from your
    device. This can be done through the browsers settings.</p>', id: 2)
  ...
  dataset.insert(title: 'Terms and Conditions', body:
    ...
    of Memory Archive's Website.</p>

    <p>By accessing this website we assume you accept these terms and
    conditions.
    Do not continue to use Memory Archive if you do not
    ...
    and ourselves. All terms refer to the offer, acceptance and consideration of
    ...
    assistance to the Client in the most appropriate manner for the express
     ...
     prevailing
      law of Netherlands. Any use of the above terminology
    ...
    <p>We employ the use of cookies. By accessing Memory Archive, you agreed to
     use cookies in agreement with the Memory Archive's
    <a href="/privacy_policy">Privacy Policy</a> and <a href="/cookie_policy">
    Cookie Policy</a>.</p>
    ...
    <p>Unless otherwise stated, Memory Archive and/or its licensors own the
     intellectual property rights for all material on Memory
     Archive. All intellectual property rights are reserved. You may access this
      from Memory Archive for your own personal use subjected
    ...
    website. Memory Archive does not filter, edit, publish or review Comments
    prior to their presence on the website. Comments do not
       reflect the views and opinions of Memory Archive,its agents and/or
        affiliates.
        Comments reflect the views and opinions of
        the person who post their views and opinions. To the extent permitted by
        applicable laws, Memory Archive shall not be liable
         for the Comments or for any liability, damages or expenses caused
          and/or
          suffered as a result of any use of and/or posting
          of and/or appearance of the Comments on this website.</p>

    <p>Memory Archive reserves the right to monitor all Comments and to remove
    any Comments which can be considered inappropriate,
    ...
    <ul>
        ...
        or custom or present commercial activities
        or unlawful activity.</li>

    </ul>

    <p>You hereby grant Memory Archive a non-exclusive license to use,
    ...
    compensates the absence of Memory Archive; and
    ...
    (a) is not in any way deceptive; (b) does not
    falsely imply sponsorship, endorsement or approval of the linking party
    and its products or services; and (c) fits
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are
     interested in linking to our website, you
     must inform us by sending an e-mail to Memory Archive. Please include your
      name, your organization name, contact
     information as well as the URL of your site, a list of any URLs from which
      you intend to link to our Website, and a
    ...
    <ul>
        ...
        <li>By use of any other description of our Website being linked to that
         makes sense within the context and format of
         content on the linking party’s site.</li>

    </ul>

    <p>No use of Memory Archive's logo or other artwork will be allowed for
    ...
    your Website. You agree to protect and defend
    us against all claims that is rising on your Website. No link(s) should
     appear on any Website that may be interpreted
    as libelous, obscene or criminal, or which infringes, otherwise violates,
     or advocates the infringement or other
    ...
    particular link to our Website. You approve
    to immediately remove all links to our Website upon request. We also
    reserve the right to amen these terms and
    conditions and it’s linking policy at any time. By continuously linking
    to our Website, you agree to be bound
    to and follow these linking terms and conditions.</p>

    <h1 class="title is-4"><strong>Removal of links from our website
    </strong></h1>

    <p>If you find any link on our Website that is offensive for any reason,
    you are free to contact and inform us
    ...
    <p>We do not ensure that the information on this website is correct, we do
      ot warrant its completeness or
    ...
    arising under
     the disclaimer, including liabilities arising in contract, in tort and
     for breach of statutory duty.</p>

    <p>As long as the website and the information and services on the
     website are provided free of charge, we
     will not be liable for any loss or damage of any nature.</p>}, id: 3)

  dataset = DB[:faq]

  dataset.insert(question: 'How do you handle user data?', answer:
    'Please see our <a href="/privacy_policy">
    Privacy Policy</a> and our <a href="/terms_and_conditions">Terms
    and Conditions</a> for information on
    how we store your data.<br><br>But in short we value your data a
    lot and do our outmost to protect it.')

  dataset.insert(question: 'Do you use cookies?', answer: 'Yes.<br><br>
    Please read our <a href="/cookie_policy">
    Cookie Policy</a> for more details as to what we use cookies for.')
